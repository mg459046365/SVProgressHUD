...
//    [SVProgressHUD showWithStatus:@"Useful Information."];
    [SVProgressHUD setMinimumSize:CGSizeMake(112, 48)];
    [SVProgressHUD setCornerRadius:24];
    [SVProgressHUD setMultiLineCornerRadius:5];
    [SVProgressHUD setInfoImage:nil];
    [SVProgressHUD showInfoWithStatus:@"Useful Information.Useful Information.Useful Information.Useful Information.Useful Information.Useful Information."];
    self.activityCount++;
}
